...
//I'll admit, Danny did a lot of the work here, and I most proofread and debugged. We did
//Work on it together though, so I am putting this up as our wordsearch.
//I detail how it works in comments (my proof that I get something out of the collab).
    private char[][] grid;
...
//this gets in the file that has all the words
...
// the main addword function.
//dR and dC are Delta row and column respectively, and indicate the change that takes place
//in the space each time a word is added.
...
//The below functions create words in specific directions using the above function.
...
//Fills in the grid by looping through it and replacing dashes with lowercase letters.
