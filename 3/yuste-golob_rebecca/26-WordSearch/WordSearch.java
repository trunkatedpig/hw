...
public class WordSearch {
    ...
    //LOADING AND ADDING WORDSS FROM FILE
    ...
    public void putWordsIn(ArrayList<String> a){
    ...
    public void putItAllTogether(String filename){
	this.loadWords(filename);
	this.putWordsIn(wordList);
	this.fillSpaces();
    }
