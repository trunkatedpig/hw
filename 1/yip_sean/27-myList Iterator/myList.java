...
public class myList implements Iterable {
	...
	private class myListIterator implements Iterator<Integer> {
		...
		public myListIterator(int[] array) {data = array;}
		
		public boolean hasNext() {return index != data.length - 1;}
	...
	public Iterator<Integer> iterator() {return new myListIterator(toArray());}
