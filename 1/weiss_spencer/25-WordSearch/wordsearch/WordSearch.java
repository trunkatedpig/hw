...
public class WordSearch {
	...
	i=0;
	    ...
	    /* this is where we're adding words in */
	i=0;
	while (i<word.length()) {
	...
	return true;
        ...
        public boolean addWordDUR(int r, int c, String word) {
	int i;
	int j;
	...
	return true;
        ...
        public boolean addWordDUL(int r, int c, String word) {
	int i;
	int j;
	...
	return true;
        ...
        public boolean addWordDDL(int r, int c, String word) {
	int i;
	int j;
	...
	return true;
        ...
        public boolean addWordDDR(int r, int c, String word) {
	int i;
	int j;
