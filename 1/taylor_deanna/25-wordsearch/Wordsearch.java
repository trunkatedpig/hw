...
public class WordSearch {
    ...
    public boolean addWordUpRight(int r, int c, String word){
	int i= 0;
	while (i<word.length()){
	    try {
    ...
    public boolean addWordDownRight(int r, int c, String word){
        int i= 0;
        while (i<word.length()){
            try {
                if (board[r-i][c+i] != '-' && board[r-i][c+i] != word.charAt(i)){
    ...
    public boolean addWordUpLeft(int r, int c, String word){
        int i= 0;
        while (i<word.length()){
            try {
                if (board[r+i][c-i] != '-' && board[r+i][c-i] != word.charAt(i)){
